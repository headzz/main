const STEPS = {
  ...
  oily_create: {page: 'oily_create', next: "oily_choose_routine", previous: "oily_first_page", middleBack: 'oilyFirstPage'},
  oily_choose_routine: {page: 'oily_choose_routine', daytime: 'oily_daytime_routine', night: "oily_night_routine", previous: 'oily_create' },
  ...
  normal_create: {page: 'normal_create', next: "normal_choose_routine", previous: "normal_first_page", middleBack: 'normalFirstPage'},
  normal_choose_routine: {page: 'normal_choose_routine', daytime: 'normal_daytime_routine', night: "normal_night_routine", previous: 'normal_create'},
  ...
  dry_create: {page: 'dry_create', next: "dry_choose_routine", previous: "dry_middle", middleBack: 'dryFirstPage'},
  dry_choose_routine: {page: 'dry_choose_routine', daytime: 'dry_daytime_routine', night: "dry_night_routine", previous: 'dry_create'},
