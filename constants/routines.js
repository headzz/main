...
const ROUTINES_DATA = {
  combination: { 
    daytime: 
    {
      limpeza: {link: 'cerave', name: 'CeraVe Foaming Cleanser',src:"./images/products/cerave.webp", description: 'LIMPA E SUAVIZA COM HIDRATAÇÃO INTENSA.', breakname: false},
      tonico: {link: 'vichyNormaderm',name: 'Vichy Normaderm Adstringente', src:"./images/products/tonico-vichy-normaderm.webp", description: 'LIMPA PROFUNDAMENTE E REMOVE O EXCESSO DE OLEOSIDADE SEM AGREDIR.', breakname: false},
      hidratacao: {link: 'vichyMineral', name: 'Vichy Minéral 89', src:"./images/products/vichy-mineral.webp", description: 'DEIXA A PELE MACIA E AGE CONTRA AGRESSORES EXTERNOS.', breakname: false},
      protetor: {link: 'bioreAqua', name: 'Bioré Aqua Rich Watery Essence FPS 50', src:"./images/products/biore-aqua-rich.webp", description: 'HIDRATA, REFRESCA E PROTEGE A SUA PELE.', breakname: false},
    },
    night: {
      limpeza: {link: 'cerave', name: 'CeraVe Foaming Cleanser', src:"./images/products/cerave.webp", description: 'LIMPA E SUAVIZA COM HIDRATAÇÃO INTENSA.', breakname: false},
      tonico: {link: 'vichyNormaderm', name: 'Vichy Normaderm Adstringente', src:"./images/products/tonico-vichy-normaderm.webp", description: 'LIMPA PROFUNDAMENTE E REMOVE O EXCESSO DE OLEOSIDADE SEM AGREDIR.', breakname: false},
      hidratacao: {link: 'vichyMineral', name: 'Vichy Minéral 89', src:"./images/products/vichy-mineral.webp", description: 'DEIXA A PELE MACIA E AGE CONTRA AGRESSORES EXTERNOS.', breakname: false},
      protetor: {link: 'clarinsDouble', name: 'Clarins Double Serum Age Control', src:"./images/products/clarins-paris.webp", description: 'PROTEGE E REJUVENESCE A SUA PELE, NUTRINDO E HIDRATANDO-A.', breakname: false},
    },
    qrCode: './images/loucas-por-beleza/pele-mista.svg'
  },
  dry: {
    daytime: {
      limpeza: {link: 'darrowNutriol', name: 'Darrow Nutriol', src:"./images/products/darrow-nutriol.webp", description: 'LIMPA E SUAVIZA COM NUTRIÇÃO INTENSA.', breakname: false},
      tonico: {link: 'clarinsSoothing', name: 'Clarins Soothing', src:"./images/products/clarins-soothing-tonico.webp", description: 'HIDRATA A SUA PELE, DEIXANDO-A MACIA E SUAVE.', breakname: false},
      hidratacao: {link: 'biodermaAtoderm', name: 'Bioderma Atoderm Intensive Baume', src:"./images/products/bioderma-atoderm-intensive-baume.webp",description: 'ALIVIA DESCONFORTO, <br/>ALÉM DE HIDRATAR E NUTRIR.', breakname: false},
      protetor: {link: 'skinAquaSuperMoisture', name: 'Skin Aqua UV Super <br/> Moisture Essence FPS 50', src:"./images/products/skin-aqua-uv-super-moisture.webp", description: 'PROTEÇÃO E HIDRATAÇÃO COM TEXTURA LEVE E DE RÁPIDA ABSORÇÃO.'	, breakname: true},
    },
    night: {
      limpeza: {link: 'darrowNutriol', name: 'Darrow Nutriol', src:"./images/products/darrow-nutriol.webp", description: 'LIMPA E SUAVIZA COM NUTRIÇÃO INTENSA.', breakname: false},
      tonico: {link: 'clarinsSoothing', name: 'Clarins Soothing', src:"./images/products/clarins-soothing-tonico.webp", description: 'HIDRATA A SUA PELE, DEIXANDO-A MACIA E SUAVE.', breakname: false},
      hidratacao: {link: 'biodermaAtoderm', name: 'Bioderma Atoderm Intensive Baume', src:"./images/products/bioderma-atoderm-intensive-baume.webp", description: 'ALIVIA DESCONFORTOS, <br/>ALÉM DE HIDRATAR E NUTRIR.', breakname: false},
      protetor: {link: 'skinceuticalsFerulic', name: 'SkinCeuticals C E Ferulic', src:"./images/products/skinceuticals-ferulic.webp", description: 'PROTEGE A PELE E COMBATE O ENVELHECIMENTO', breakname: false},
    },
    qrCode: './images/loucas-por-beleza/pele-seca.svg'
  },
  oily: {
    daytime: {
      limpeza: {link: 'darrowActine', name: 'Darrow Actine', src:"./images/products/darrow-actine.webp", description: 'REDUZ A OLEOSIDADE SEM DEIXAR A PELE RESSECAR, DEIXANDO-A RADIANTE.' , breakname: false},
      tonico: {link: 'skinceuticalsBlemish', name: 'SkinCeuticals Blemish + Age Solution', src:"./images/products/skinceuticals-tonico-blemish-age.webp", description: 'REMOVE IMPUREZAS, DIMINUI A OLEOSIDADE E RENOVA A SUA PELE.' , breakname: false},
      hidratacao: {link: 'laRocheposay', name: 'La Roche-Posay Effaclar Mat', src:"./images/products/la-roche-posay-effaclar-mat-hidratante.webp", description: 'HIDRATA, CONTROLA A OLEOSIDADE E TEM ACABAMENTO MATTE.' , breakname: false},
      protetor: {link: 'neostrataMinesol', name: 'NeoStrata Minesol Oil Control FPS 70',src:"./images/products/neostrata-minesol-oil-control.webp", description: 'PROTEGE DO SOL E DO ENVELHECIMENTO E REDUZ A OLEOSIDADE' , breakname: false},
    },
    night: {
      limpeza: {link: 'darrowActine', name: 'Darrow Actine', src:"./images/products/darrow-actine.webp", description: 'REDUZ A OLEOSIDADE SEM DEIXAR A PELE RESSECAR, DEIXANDO-A RADIANTE.' , breakname: false},
      tonico: {link: 'skinceuticalsBlemish', name: 'SkinCeuticals Blemish + Age Solution', src:"./images/products/skinceuticals-tonico-blemish-age.webp", description: 'REMOVE IMPUREZAS, DIMINUI A OLEOSIDADE E RENOVA A SUA PELE.' , breakname: false},
      hidratacao: {link: 'laRocheposay', name: 'La Roche-Posay Effaclar Mat', src:"./images/products/la-roche-posay-effaclar-mat-hidratante.webp", description: 'HIDRATA, CONTROLA A OLEOSIDADE E TEM ACABAMENTO MATTE.', breakname: false},
      protetor: {link: 'esthedermIntensive', name: 'Esthederm Intensive Propolis + Salicylic Acid', src:"./images/products/esthederm-intensive-propolis.webp", description: 'CONTROLA A OLEOSIDADE E COMBATE O ENVELHECIMENTO E A ACNE.', breakname: false},
    },
    qrCode: './images/loucas-por-beleza/pele-oleosa.svg'
  },
  normal: {
    daytime: {
      limpeza: {link: 'vichyPurete', name:'Vichy Pureté Thermale', src:"./images/products/vichy-purete-thermale-espuma.webp", description: 'LIMPEZA SUAVE E PROFUNDA, REMOVE IMPUREZAS E ILUMINA A PELE.', breakname: false},
      tonico: {link: 'dermageGlycolique', name:'Dermage Glycolique Daily Peel', src:"./images/products/dermage-glycolique-daily.webp", description: 'DEIXA A PELE UNIFORMIZADA, <br/>LIMPA E ILUMINADA.', breakname: false},
      hidratacao: {link: 'hadaLabo', name: 'Hada Labo Gokujyun White Gel FPS 50', src:"./images/products/hada-labo-gokujyun.webp", description: 'UM HIDRATANTE SEM ÓLEO PARA EVITAR <br/>O EXCESSO DE OLEOSIDADE NA PELE.', breakname: false},
      protetor: {link: 'isdinFotoprotector', name: 'ISDIN Fotoprotector Fusion <br/> Water 5 Stars FPS 60', src:"./images/products/ISDIN-Fotoprotector-Fusion.webp", description: 'PROTEGE A SUA PELE CONTROLA A OLEOSIDADE E PROMOVE TOQUE SECO.', breakname: true},
    },
    night: {
      limpeza: {link: 'vichyPurete', name:'Vichy Pureté Thermale',  src:"./images/products/vichy-purete-thermale-espuma.webp", description: 'LIMPEZA SUAVE E PROFUNDA, REMOVE IMPUREZAS E ILUMINA A PELE.', breakname: false},
      tonico: {link: 'dermageGlycolique', name:'Dermage Glycolique Daily Peel', src:"./images/products/dermage-glycolique-daily.webp", description: 'DEIXA A PELE UNIFORMIZADA, <br/>LIMPA E ILUMINADA.', breakname: false},
      hidratacao: {link: 'vichyMineral', name: 'Vichy Minéral 89', src:"./images/products/vichy-mineral.webp", description: 'DEIXA A PELE MACIA E AGE CONTRA AGRESSORES EXTERNOS', breakname: false},
      protetor: {link: 'cliniqueSmart', name: 'Clinique Smart Night Clinical MD Retinol', src:"./images/products/clinique-smart-night.webp", description: 'ACELERA A RENOVAÇÃO CELULAR E SUAVIZA RUGAS E LINHAS FINAS', breakname: false},
    },
